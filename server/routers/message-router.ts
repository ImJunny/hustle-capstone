...
import { z } from "zod";
import { getChatInfo, getMessagePreviews, sendTextMessage } from "../actions/message-actions";
...
export const messageRouter = createTRPCRouter({
    ...
    .mutation(async ({ input }) => {
      await sendTextMessage(input.sender_uuid, input.receiver_uuid, input.message)
    }),
