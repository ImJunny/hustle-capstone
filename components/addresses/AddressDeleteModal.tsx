...
export default function AddressDeleteModal({
  ...
  const { mutate: deleteAddress } = trpc.address.delete_address.useMutation({
    onSuccess: () => {
      utils.address.invalidate();
      Toast.show({
        text1: "Successfully deleted address",
        swipeable: false,
      });
    },
    onError: (error) => {
        ...
        >
          <Pressable>
            ...
            >
              ...
              <Text>
                Are you sure you want to delete this address? It will be deleted
